...
# 8 "sort-6.c"
    if (i < 6U) {
      __CrownBranch(9, 6, 1, 9, "sort-6.c");

    }
# 8 "sort-6.c"
      else {
      __CrownBranch(10, 7, 0, 9, "sort-6.c");
# 8 "sort-6.c"
      goto while_break;
    }
    }
...
# 11 "sort-6.c"
    if (i < 5U) {
      __CrownBranch(24, 15, 1, 12, "sort-6.c");

    }
# 11 "sort-6.c"
      else {
      __CrownBranch(25, 16, 0, 12, "sort-6.c");
# 11 "sort-6.c"
...
# 12 "sort-6.c"
      if (j < 6U) {
        __CrownBranch(33, 22, 1, 13, "sort-6.c");

      }
# 12 "sort-6.c"
        else {
        __CrownBranch(34, 23, 0, 13, "sort-6.c");
# 12 "sort-6.c"
...
# 13 "sort-6.c"
      if (a[i] > a[j]) {
        __CrownBranch(38, 25, 1, 14, "sort-6.c");
...
# 13 "sort-6.c"
        ...
        __CrownBranch(39, 26, 0, 14, "sort-6.c");
...
# 19 "sort-6.c"
    if (i < 5U) {
      __CrownBranch(59, 36, 1, 20, "sort-6.c");

    }
# 19 "sort-6.c"
      else {
      __CrownBranch(60, 37, 0, 20, "sort-6.c");
# 19 "sort-6.c"
...
# 20 "sort-6.c"
    if (a[i] <= a[i + 1U]) {
      __CrownBranch(64, 39, 1, 21, "sort-6.c");

    }
# 20 "sort-6.c"
      else {
      __CrownBranch(65, 40, 0, 21, "sort-6.c");
