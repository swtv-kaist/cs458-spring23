...
#line 8
  while (1) {
    ...
    __CrownLoad(6, (unsigned long )0, 4, (long long )7U, (double )7U);
...
#line 8
    cnt_symbolic_var ++;
    __CrownLoad(16, (unsigned long )(& i), 4, (long long )i, (double )i);
    __CrownLoad(15, (unsigned long )0, 4, (long long )1U, (double )1U);
...
#line 8
  ...
  __CrownLoad(18, (unsigned long )0, 4, (long long )0U, (double )0U);
...
#line 11
  while (1) {
    ...
    {
    __CrownLoad(22, (unsigned long )(& i), 4, (long long )i, (double )i);
    __CrownLoad(21, (unsigned long )0, 4, (long long )6U, (double )6U);
...
#line 11
    ...
    __CrownLoad(26, (unsigned long )0, 4, (long long )1U, (double )1U);
...
#line 12
    while (1) {
      ...
      {
      __CrownLoad(31, (unsigned long )(& j), 4, (long long )j, (double )j);
      __CrownLoad(30, (unsigned long )0, 4, (long long )7U, (double )7U);
...
#line 16
      ...
      __CrownLoad(47, (unsigned long )(& j), 4, (long long )j, (double )j);
      __CrownLoad(46, (unsigned long )0, 4, (long long )1U, (double )1U);
...
#line 12
    ...
    __CrownLoad(51, (unsigned long )(& i), 4, (long long )i, (double )i);
    __CrownLoad(50, (unsigned long )0, 4, (long long )1U, (double )1U);
...
#line 11
  ...
  __CrownLoad(53, (unsigned long )0, 4, (long long )0U, (double )0U);
...
#line 19
  while (1) {
    ...
    {
    __CrownLoad(57, (unsigned long )(& i), 4, (long long )i, (double )i);
    __CrownLoad(56, (unsigned long )0, 4, (long long )6U, (double )6U);
...
#line 20
    if (a[i] <= a[i + 1U]) {
      ...
      __CrownLoad(65, (unsigned long )0, 6, (long long )"a[i] <= a[i+1]", 8);
      __CrownLoad(66, (unsigned long )0, 6, (long long )"sort-4.c", 8);
      __CrownLoad(67, (unsigned long )0, 4, (long long )20U, (double )20U);
      __CrownLoad(68, (unsigned long )0, 6, (long long )"main", 8);
#line 20
      __assert_fail("a[i] <= a[i+1]", "sort-4.c", 20U, "main");
      __CrownClearStack(69);
    }
    }
    __CrownLoad(72, (unsigned long )(& i), 4, (long long )i, (double )i);
    __CrownLoad(71, (unsigned long )0, 4, (long long )1U, (double )1U);
...
#line 19
  ...
  __CrownLoad(74, (unsigned long )0, 5, (long long )0, (double )0);
