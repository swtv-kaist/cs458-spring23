...
# 1 "<command-line>" 2
# 1 "./limit4-sym-index.cil.c"
# 6 "limit4-sym-index.c"
void __globinit_limit4_sym_index(void) ;
...
int main(void)
{
  ...
  {
  __globinit_limit4_sym_index();
  __CrownCheckSymbolic(3, "main");
  __CrownCall(2, 1);
  __CrownClearStack(1);
# 10 "limit4-sym-index.c"
  __CrownInt(& x, cnt_symbolic_var, 10, (char *)"limit4-sym-index.c", "x");
...
# 11 "limit4-sym-index.c"
    if (0 < x) {
      __CrownBranch(11, 6, 1, 12, "limit4-sym-index.c");
      {
...
# 11 "limit4-sym-index.c"
      if (x <= 4) {
        __CrownBranch(16, 7, 1, 12, "limit4-sym-index.c");

      }
# 11 "limit4-sym-index.c"
        else {
        __CrownBranch(17, 8, 0, 12, "limit4-sym-index.c");
# 11 "limit4-sym-index.c"
        goto _L;
      }
      }
...
# 11 "limit4-sym-index.c"
      ...
      __CrownBranch(12, 9, 0, 12, "limit4-sym-index.c");
      _L:
      ...
      __CrownLoad(24, (unsigned long )0, 6, (long long )"limit4-sym-index.c", 8);
...
# 11 "limit4-sym-index.c"
      fprintf((FILE * __restrict )stderr, (char const * __restrict )"### SYM_assume(%s) is violated at Line %d (%s in %s) ###\n",
              "0< x && x <=4", 11, "main", "limit4-sym-index.c");
...
# 11 "limit4-sym-index.c"
      if (! f) {
        __CrownBranch(38, 11, 1, 12, "limit4-sym-index.c");
...
# 11 "limit4-sym-index.c"
        ...
        __CrownBranch(39, 12, 0, 12, "limit4-sym-index.c");
...
# 14 "limit4-sym-index.c"
  array[0] = 0;
  __CrownLoad(62, (unsigned long )0, 5, (long long )1, (double )1);
  __CrownStore(63, (unsigned long )(& array[1]));
# 15 "limit4-sym-index.c"
  array[1] = 1;
  __CrownLoad(64, (unsigned long )(& x), 5, (long long )x, (double )x);
  __CrownStore(65, (unsigned long )(& array[2]));
# 16 "limit4-sym-index.c"
  array[2] = x;
  __CrownLoad(66, (unsigned long )0, 5, (long long )4, (double )4);
  __CrownStore(67, (unsigned long )(& array[3]));
# 17 "limit4-sym-index.c"
  array[3] = 4;
  __CrownLoad(70, (unsigned long )(& array[x - 1]), 5, (long long )array[x - 1], (double )array[x - 1]);
  __CrownLoad(69, (unsigned long )0, 5, (long long )3, (double )3);
  __CrownApply2(68, 13, 5, (long long )(array[x - 1] == 3), (double )(array[x - 1] == 3));
# 19 "limit4-sym-index.c"
  if (array[x - 1] == 3) {
    __CrownBranch(71, 18, 1, 20, "limit4-sym-index.c");
    __CrownLoad(73, (unsigned long )0, 6, (long long )((char const * __restrict )"ERROR\n"),
                8);
...
# 19 "limit4-sym-index.c"
    ...
    __CrownBranch(72, 19, 0, 20, "limit4-sym-index.c");
    __CrownLoad(77, (unsigned long )0, 6, (long long )((char const * __restrict )"Fine\n"),
                8);
    __CrownSetCallerCalleeName(78, "main", "printf");
# 20 "limit4-sym-index.c"
    printf((char const * __restrict )"Fine\n");
    __CrownEnableSymbolic(80, "main");
    __CrownClearStack(79);
  }
  __CrownLoad(81, (unsigned long )0, 5, (long long )0, (double )0);
  __CrownStore(82, (unsigned long )(& __retres5));
# 21 "limit4-sym-index.c"
  __retres5 = 0;
  __CrownLoad(83, (unsigned long )(& __retres5), 5, (long long )__retres5, (double )__retres5);
  __CrownReturn(84);
# 6 "limit4-sym-index.c"
  return (__retres5);
}
