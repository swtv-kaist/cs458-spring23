...
#line 13
  if ((unsigned long )ptr == (unsigned long )(& x)) {
    __CrownBranch(13, 3, 1, __LINE__, __FILE__);
...
#line 13
    ...
    __CrownBranch(14, 4, 0, __LINE__, __FILE__);
    {
...
#line 14
    if ((unsigned long )ptr == (unsigned long )(& y)) {
      __CrownBranch(24, 5, 1, __LINE__, __FILE__);
...
#line 14
      ...
      __CrownBranch(25, 6, 0, __LINE__, __FILE__);
...
#line 16
  if (*ptr == x) {
    __CrownBranch(33, 8, 1, __LINE__, __FILE__);
...
#line 16
    ...
    __CrownBranch(34, 9, 0, __LINE__, __FILE__);
    {
...
#line 17
    if (*ptr == y) {
      __CrownBranch(42, 10, 1, __LINE__, __FILE__);
...
#line 17
      ...
      __CrownBranch(43, 11, 0, __LINE__, __FILE__);
