...
#line 21 "limit4-sym-index-resolved.c"
...
#line 25 "limit4-sym-index-resolved.c"
int main(void) ;
#line 25 "limit4-sym-index-resolved.c"
...
#line 34
    if (x - 1 == 0) {
      __CrownBranch(73, 22, 1, __LINE__, __FILE__);
#line 34
      goto case_0;
    } 
      #line 34
      else {
      __CrownBranch(74, 23, 0, __LINE__, __FILE__);
...
#line 34
    if (x - 1 == 1) {
      __CrownBranch(80, 25, 1, __LINE__, __FILE__);
#line 34
      goto case_1;
    } 
      #line 34
      else {
      __CrownBranch(81, 26, 0, __LINE__, __FILE__);
...
#line 34
    if (x - 1 == 2) {
      __CrownBranch(87, 28, 1, __LINE__, __FILE__);
#line 34
      goto case_2;
    } 
      #line 34
      else {
      __CrownBranch(88, 29, 0, __LINE__, __FILE__);
...
#line 34
    if (x - 1 == 3) {
      __CrownBranch(94, 31, 1, __LINE__, __FILE__);
#line 34
      goto case_3;
    } 
      #line 34
      else {
      __CrownBranch(95, 32, 0, __LINE__, __FILE__);
...
#line 36
  if (tmp == 3) {
    __CrownBranch(107, 46, 1, __LINE__, __FILE__);
...
#line 37
    ...
    __CrownBranch(108, 47, 0, __LINE__, __FILE__);
