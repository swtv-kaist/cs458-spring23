...
#line 17
  ...
  __CrownLoad(3, (unsigned long )0, 5, (long long )1, (double )1);
  __CrownApply2(2, 0, 5, (long long )(cnt_symbolic_var + 1), (double )(cnt_symbolic_var + 1));
  __CrownStore(5, (unsigned long )(& cnt_symbolic_var));
#line 17
  cnt_symbolic_var ++;
  {
  __CrownLoad(8, (unsigned long )0, 5, (long long )0, (double )0);
  __CrownLoad(7, (unsigned long )(& n), 5, (long long )n, (double )n);
  __CrownApply2(6, 20, 5, (long long )(0 < n), (double )(0 < n));
#line 20
  if (0 < n) {
    __CrownBranch(9, 3, 1, __LINE__, __FILE__);
    {
    __CrownLoad(13, (unsigned long )(& n), 5, (long long )n, (double )n);
    __CrownLoad(12, (unsigned long )0, 5, (long long )8, (double )8);
...
#line 20
    if (n <= 8) {
      ...
      __CrownLoad(16, (unsigned long )0, 6, (long long )((char const   * __restrict  )"Invalid input generated:n=%d\n"),
                  8);
      __CrownLoad(17, (unsigned long )(& n), 5, (long long )n, (double )n);
#line 20
...
#line 20
    ...
    __CrownLoad(21, (unsigned long )0, 6, (long long )((char const   * __restrict  )"Invalid input generated:n=%d\n"),
                8);
    __CrownLoad(22, (unsigned long )(& n), 5, (long long )n, (double )n);
#line 20
    printf((char const   * __restrict  )"Invalid input generated:n=%d\n", n);
    __CrownClearStack(23);
    __CrownLoad(24, (unsigned long )0, 5, (long long )-1, (double )-1);
#line 20
    exit(-1);
...
#line 24
  while (1) {
    ...
    {
    __CrownLoad(30, (unsigned long )(& c), 5, (long long )c, (double )c);
    __CrownLoad(29, (unsigned long )(& n), 5, (long long )n, (double )n);
...
#line 27
    ...
    __CrownLoad(34, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 27
    ...
    {
    __CrownLoad(39, (unsigned long )(& c), 5, (long long )c, (double )c);
    __CrownLoad(38, (unsigned long )0, 5, (long long )0, (double )0);
...
#line 30
      if (! (array[c - 1] <= array[c])) {
        ...
        __CrownLoad(48, (unsigned long )0, 6, (long long )((char const   * __restrict  )"Invalid input generated:a[%d]=%d\n"),
                    8);
        __CrownLoad(49, (unsigned long )(& c), 5, (long long )c, (double )c);
...
#line 30
        ...
        __CrownLoad(52, (unsigned long )0, 5, (long long )-1, (double )-1);
#line 30
        exit(-1);
    ...
    __CrownLoad(56, (unsigned long )(& c), 5, (long long )c, (double )c);
    __CrownLoad(55, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 41
  first = 0;
  __CrownLoad(65, (unsigned long )(& n), 5, (long long )n, (double )n);
  __CrownLoad(64, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 42
  ...
  __CrownLoad(70, (unsigned long )(& last), 5, (long long )last, (double )last);
  __CrownApply2(69, 0, 5, (long long )(first + last), (double )(first + last));
  __CrownLoad(68, (unsigned long )0, 5, (long long )2, (double )2);
...
#line 46
    if (array[middle] < search) {
      ...
      __CrownLoad(84, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 53
    ...
    __CrownLoad(99, (unsigned long )0, 5, (long long )2, (double )2);
...
#line 55
  ...
  __CrownLoad(104, (unsigned long )0, 5, (long long )-1, (double )-1);
...
{ 
  ...
  {
  __CrownLoad(113, (unsigned long )(& idx), 5, (long long )idx, (double )idx);
  __CrownLoad(112, (unsigned long )0, 5, (long long )-1, (double )-1);
  __CrownApply2(111, 13, 5, (long long )(idx == -1), (double )(idx == -1));
#line 63
  if (idx == -1) {
    __CrownBranch(114, 42, 1, __LINE__, __FILE__);
    __CrownLoad(116, (unsigned long )0, 5, (long long )0, (double )0);
...
#line 64
    while (1) {
      while_continue: /* CIL Label */ ;
      {
      __CrownLoad(120, (unsigned long )(& i), 5, (long long )i, (double )i);
      __CrownLoad(119, (unsigned long )(& n), 5, (long long )n, (double )n);
...
#line 65
      if (array[i] == search) {
        ...
        __CrownLoad(128, (unsigned long )0, 5, (long long )0, (double )0);
...
#line 65
      ...
      __CrownLoad(132, (unsigned long )(& i), 5, (long long )i, (double )i);
      __CrownLoad(131, (unsigned long )0, 5, (long long )1, (double )1);
...
{ 
  ...
  __CrownLoad(143, (unsigned long )0, 5, (long long )0, (double )0);
...
#line 74
  while (1) {
    while_continue: /* CIL Label */ ;
    {
    __CrownLoad(147, (unsigned long )(& i), 5, (long long )i, (double )i);
    __CrownLoad(146, (unsigned long )(& n), 5, (long long )n, (double )n);
...
#line 75
    if (old_array[i] != array[i]) {
      ...
      __CrownLoad(155, (unsigned long )0, 5, (long long )0, (double )0);
...
#line 75
    ...
    __CrownLoad(159, (unsigned long )(& i), 5, (long long )i, (double )i);
    __CrownLoad(158, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 74
  ...
  __CrownLoad(161, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 82
  ...
  __CrownLoad(168, (unsigned long )0, 5, (long long )0, (double )0);
...
#line 83
  while (1) {
    while_continue: /* CIL Label */ ;
    {
    __CrownLoad(172, (unsigned long )(& i), 5, (long long )i, (double )i);
    __CrownLoad(171, (unsigned long )(& n), 5, (long long )n, (double )n);
...
#line 83
    old_array[i] = array[i];
    __CrownLoad(179, (unsigned long )(& i), 5, (long long )i, (double )i);
...
#line 88
  ...
  __CrownLoad(182, (unsigned long )0, 5, (long long )1, (double )1);
...
#line 90
  ...
  __CrownLoad(188, (unsigned long )(& idx), 5, (long long )idx, (double )idx);
...
#line 94
  ...
  __CrownLoad(192, (unsigned long )(& tmp), 5, (long long )tmp, (double )tmp);
#line 94
  if (tmp) {
    ...
    __CrownLoad(195, (unsigned long )0, 6, (long long )"check(idx,search)", 8);
    __CrownLoad(196, (unsigned long )0, 6, (long long )"bin-search-crown.c", 8);
    __CrownLoad(197, (unsigned long )0, 4, (long long )94U, (double )94U);
    __CrownLoad(198, (unsigned long )0, 6, (long long )"main", 8);
#line 94
...
#line 95
  if (tmp___0) {
    ...
    __CrownLoad(205, (unsigned long )0, 6, (long long )"check2()", 8);
    __CrownLoad(206, (unsigned long )0, 6, (long long )"bin-search-crown.c", 8);
    __CrownLoad(207, (unsigned long )0, 4, (long long )95U, (double )95U);
    __CrownLoad(208, (unsigned long )0, 6, (long long )"main", 8);
#line 95
    __assert_fail("check2()", "bin-search-crown.c", 95U, "main");
    __CrownClearStack(209);
  }
  __CrownLoad(210, (unsigned long )0, 5, (long long )0, (double )0);
