...
## Syllabus
This class covers automated SW testing/verification techniques to detect SW bugs effectively and efficiently by analyzing SW source code and its runtime behaviors. In particular, this class focuses to teach techniques that automatically generate test cases to achieve high code coverage and, thus, to detect many bugs.
